...
export const slideFadeinUp      = trigger('slideFadeinUp', [
    ...
    transition('* => *', [
        ...
        query(':enter', [style({ display: 'block', opacity: '0', transform: 'translateY(20px)' })],{ optional: true }),
        query(':leave', [
...
export const fadein             = trigger('fadein', [
    ...
    transition('* => *', [
        ...
        group([
            ...
            query(':enter', [animate('300ms ease-in-out', style({ opacity: '1' }))], { delay: 400, optional: true }),
        ]),
        query(':enter', animateChild(),{ optional: true}),
    ]),
])
